...
Clone the repository in a desired directory with `git clone` and run in `python install -r requirements.txt` to install the project dependencies. Then, simply run `python app.py` to start the program.
