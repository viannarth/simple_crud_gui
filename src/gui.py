...
class InsertPage(tk.Frame):
    def __init__(self, master):
        ...
        cep_val.trace_add("write", verify_cep)
        data_nascimento_val.trace_add("write", verify_data_nascimento)
        contato_val.trace_add("write", verify_contato)
        cpf_cnpj_val.trace_add("write", verify_cpf_cnpj)
